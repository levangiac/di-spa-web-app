...
export default function SpaError({ reset }: Props) {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center space-y-4">
      <p className="text-3xl" aria-hidden="true">😔</p>
      <h2 className="font-semibold text-foreground text-lg">Không thể tải thông tin spa</h2>
      <p className="text-sm text-muted-foreground max-w-xs">
        Vui lòng thử lại hoặc quay về trang tìm kiếm.
      </p>
      <button
        onClick={reset}
